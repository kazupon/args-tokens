...
# regenerate the API references in docs/ from the JSDoc
# (run it after changing the JSDoc of the public API, and commit the result; the CI checks that docs/ is up to date)
$ vp run build:docs
```
